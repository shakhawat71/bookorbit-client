...
export default function Navbar() {
  // Later you’ll replace this with real AuthContext (user, logout)
  const user = null; // example: { displayName:"", photoURL:"" }
  ...
  const navItems = (
    <>
      ...
      <li><NavLink className={navLinkClass} to="/books">Books</NavLink></li>
      <li><NavLink className={navLinkClass} to="/dashboard/my-orders">Dashboard</NavLink></li>
    </>
  );
    ...
    <div className="navbar shadow-sm sticky top-0 z-50">
      ...
      <div className="navbar-start">
        ...
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-3 w-52 rounded-box bg-base-100-100 p-2 shadow"
          >
            {navItems}
            {!user && (
              <>
      ...
      <div className="navbar-end gap-2">
        ...
        <NavLink
            ...
            `px-4 py-2 rounded-md font-medium transition ${
                isActive
                ? "bg-[#8B5E3C] text-white"
                : "bg-base-100-100 text-[#8B5E3C] border border-[#8B5E3C] hover:bg-[#A47148] hover:text-white"
            }`
            }
        >
            Login
        ...
        >
          ...
          <div className="dropdown dropdown-end">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm dropdown-content bg-base-100-100 rounded-box z-10 mt-3 w-52 p-2 shadow"
            >
              <li>
